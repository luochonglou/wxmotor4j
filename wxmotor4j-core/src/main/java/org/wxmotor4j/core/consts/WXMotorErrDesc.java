 ...
 * 微信全局返回码说明
 * 
 * @ClassName: WXMotorErrDesc
 * @author Tluo
 * @date 2017年10月12日
 *
 */
public enum WXMotorErrDesc {
	/**/EF1(-1, "系统繁忙，此时请开发者稍候再试。"),
	/**/E0(0, "请求成功。"),
	/**/E40001(40001,
	...
	/**/E40053(40053, "不合法的actioninfo，请开发者确认参数正确"),
	/**/E40056(40056, "不合法的Code码"),
	/**/E40060(40060, "删除单篇图文时，指定的 article_idx 不合法"),

	/**/E40071(40071, "不合法的卡券类型"),
	/**/E40072(40072, "不合法的编码方式"),
	/**/E40078(40078, "不合法的卡券状态"),
	/**/E40079(40079, "不合法的时间"),
	/**/E40080(40080, "不合法的CardExt"),
	/**/E40099(40099, "卡券已被核销"),
	/**/E40100(40100, "不合法的时间区间"),
	/**/E40116(40116, "不合法的Code码"),
	/**/E40117(40117, "分组名字不合法"),
	/**/E40118(40118, "media_id大小不合法"),
	/**/E40119(40119, "button类型错误"),
	/**/E40120(40120, "button类型错误"),
	/**/E40121(40121, "不合法的media_id类型"),
	/**/E40122(40122, "不合法的库存数量"),
	/**/E40124(40124, "会员卡设置查过限制的 custom_field字段"),
	/**/E40127(40127, "卡券被用户删除或转赠中"),
	/**/E40132(40132, "微信号不合法"),
	...
	/**/E43005(43005, "需要好友关系"),
	/**/E43009(43009, "自定义SN权限，请前往公众平台申请"),
	/**/E43010(43010, "无储值权限，请前往公众平台申请"),
	...
	/**/E45011(45011, "API调用太频繁，请稍候再试"),
	/**/E45015(45015, "回复时间超过限制"),
	/**/E45016(45016, "系统分组，不允许修改"),
	/**/E45017(45017, "分组名字过长"),
	/**/E45018(45018, "分组数量超过上限"),
	/**/E45021(45021, "字段超过长度限制，请参考相应接口的字段说明"),
	/**/E45030(45030, "该cardid无接口权限"),
	/**/E45031(45031, "库存为0"),
	/**/E45033(45033, "用户领取次数超过限制get_limit"),
	...
	private WXMotorErrDesc(Integer errcode, String desc) {
	...
	public static String getDesc(int errcode) {
		...
		for (WXMotorErrDesc enumDesc : WXMotorErrDesc.values()) {
			if (errcode == enumDesc.getErrcode()) {
