...
public abstract class WxMpProcessor {
	/**
	 * 处理微信消息的类型
	 */
	 ...
	 */
	private WxMpCentralProcessing centralProcessing;
	 ...
	 */
	public WxMpProcessor(String msgType, String event, String eventKey,
			WxMpCentralProcessing centralProcessing) {
	...
	public WxMpCentralProcessing getCentralProcessing() {
